 ...
 */
function parseAnnotatedTest(annotatedText) {
 ...
 */
function getTokensAtPositions(markdownText, positions) {
    ...
    while (scanner.token !== 1 /* SyntaxKind2.EndOfFileToken */ && positionIndex < sortedPositions.length) {
        scanner.scan();
...
function syntaxKindToString(kind) {
    switch (kind) {
        case 0 /* SyntaxKind2.Unknown */: return 'Unknown';
        case 1 /* SyntaxKind2.EndOfFileToken */: return 'EndOfFileToken';
        case 2 /* SyntaxKind2.StringLiteral */: return 'StringLiteral';
        case 3 /* SyntaxKind2.WhitespaceTrivia */: return 'WhitespaceTrivia';
        case 4 /* SyntaxKind2.NewLineTrivia */: return 'NewLineTrivia';
 ...
 */
export function verifyTokens(annotatedText) {
    try {
        ...
        const normalizedText = annotatedText.replace(/^\n/, '').replace(/\n$/, '');
        return normalizedText + '\nERROR: Failed to parse annotated test format: ' + error.message;
    }
}
