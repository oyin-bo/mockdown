...
describe('Scanner2 Stage 1: Text Lines + Whitespace/Newlines', () => {
    ...
    test('should tokenize simple text line', () => {
        ...
        expect(scanner.tokenFlags & 2 /* TokenFlags2.IsAtLineStart */).toBeTruthy();
...
Final line after blank`;
        ...
        const textTokens = tokens.filter(t => t.kind === 2 /* SyntaxKind2.StringLiteral */);
        const newlineTokens = tokens.filter(t => t.kind === 4 /* SyntaxKind2.NewLineTrivia */);
        const blankLineTokens = tokens.filter(t => t.flags & 4 /* TokenFlags2.IsBlankLine */);
    ...
    test('should set rollback flags appropriately', () => {
        ...
        scanner.scan();
        expect(scanner.token).toBe(2 /* SyntaxKind2.StringLiteral */);
        expect(scanner.tokenFlags & 8 /* TokenFlags2.CanRollbackHere */).toBeTruthy();
        expect(scanner.tokenFlags & 2 /* TokenFlags2.IsAtLineStart */).toBeTruthy();
