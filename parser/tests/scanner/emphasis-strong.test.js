...
describe('Emphasis and Strong', () => {
    describe('Emphasis and Strong flanking', () => {
        test('asterisk flanking: a*bc*', () => {
            ...
            expect(open.flags & 1024 /* TokenFlags.CanClose */).toBeTruthy();
            expect(close.flags & 512 /* TokenFlags.CanOpen */).toBeFalsy();
            expect(close.flags & 512 /* TokenFlags.CanOpen */).toBeFalsy();
        });
        test('double asterisk strong: a**b**', () => {
            ...
            const open = tokens[1];
            expect(open.flags & 512 /* TokenFlags.CanOpen */).toBeTruthy();
            expect(open.flags & 1024 /* TokenFlags.CanClose */).toBeTruthy();
            const close = tokens[3];
            expect(close.flags & 512 /* TokenFlags.CanOpen */).toBeFalsy();
            expect(close.flags & 1024 /* TokenFlags.CanClose */).toBeTruthy();
        });
